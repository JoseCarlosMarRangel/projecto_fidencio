...
<body >
	...
	<form action="administrador.html" autocomplete="off" method="POST">

		
	    <input type="password" name="password" id="password" placeholder="Password de administrador" required >

		<input type="submit" value="Confirmar" style="margin-left: 170px; margin-right:100px; background-color: #755d45; margin-bottom: 0px; margin-top: 20px; color: white;font: italic 120% Segoe UI" >	
